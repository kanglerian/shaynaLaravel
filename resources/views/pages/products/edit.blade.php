                            ...
                            <form action="{{ route('products.update', $item->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') ? old('name') : $item->name }}"
                                        class="form-control @error('name') is-invalide @enderror" />
                                    @error('name') <div class="text-muted">{{ $message }}</div>@enderror
                                </div>
                                <div class="form-group">
                                    <label for="type" class="form-control-label">Tipe Barang</label>
                                    <input type="text" name="type" value="{{ old('type') ? old('type') : $item->type }}"
                                        class="form-control @error('type') is-invalide @enderror" />
                                    @error('type') <div class="text-muted">{{ $message }}</div>@enderror
                                </div>
                                <div class="form-group">
                                    <label for="type" class="form-control-label">Deskripsi Barang</label>
                                    <textarea name="description"
                                        class="ckeditor form-control @error('description') is-invalide @enderror">{{ old('description') ? old('description') : $item->description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity"
                                        ...
                                        class="form-control @error('quantity') is-invalide @enderror" />
