                            ...
                            <form action="{{ route('transactions.update', $item->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email"
                                        ...
                                        class="form-control @error('email') is-invalide @enderror" />
                                    @error('email') <div class="text-muted">{{ $message }}</div>@enderror
                                </div>
                                <div class="form-group">
                                    <label for="number" class="form-control-label">Nomor HP</label>
                                    <input type="text" name="number"
                                        value="{{ old('price') ? old('number') : $item->number }}"
                                        class="form-control @error('number') is-invalide @enderror" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address"
                                        ...
                                        class="form-control @error('address') is-invalide @enderror" />
