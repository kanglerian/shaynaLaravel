    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="{{ route('productGallery.index') }}"> <i class="menu-icon fa fa-list"></i>Lihat Foto
                        Barang</a>
                </li>
                <li class="">
                    <a href="{{ route('productGallery.create') }}"> <i class="menu-icon fa fa-plus"></i>Tambah Foto
                        Barang</a>
                </li>
